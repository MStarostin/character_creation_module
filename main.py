...
def attack(char_name: str, char_class: str) -> str:
    """Attack function.
    Receive name and class of player
    and return score of loss.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Defencd function.
    Receive name and class of player and return score
    of blocked loss.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Spesial function.
    Receive name and class of player
    and return score of spesial skills.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    Receive name and class of player,
    print charatter of player and call attack, defence and
    special functions.
    """
    if char_class == 'warrior':
